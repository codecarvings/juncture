...
export interface TriggerFrame<D extends Driver> extends Frame<D> {
...
export interface TriggerFrameHost<D extends Driver> {
  readonly trigger: TriggerFrame<D>;
}

export function createTriggerFrame<D extends Driver>(
...
export interface OverrideTriggerFrame<D extends Driver, S> extends TriggerFrame<D> {
  readonly parent: S;
}
